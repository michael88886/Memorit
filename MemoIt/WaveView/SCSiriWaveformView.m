...
{
    // <waveColors> is not empty, use its count as number of waves
    if (self.waveColors.count > 0) {
        self.numberOfWaves = self.waveColors.count;
    }
	...
	for (int i = 0; i < self.numberOfWaves; i++) {
        ...
        if (self.waveColors.count > 0) {
            ...
            [[color colorWithAlphaComponent:multiplier * CGColorGetAlpha(color.CGColor)] set];
        }
        else {
