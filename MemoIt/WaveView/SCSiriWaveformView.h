...
/* [Custom variables]
 * Multiple color for different stroke
 * If it is not empty, <numberOfWaves> will be ignore and  use the count instead
 * Default: empty
 */
@property (nonatomic, strong) IBInspectable NSArray <UIColor *> *waveColors;
